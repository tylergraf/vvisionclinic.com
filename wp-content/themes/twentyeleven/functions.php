        ...
        jQuery('.menu-item').click(function(e){
            function navToggle(element){
                if (element.hasClass('down')){
                    ...
                    element.find('ul').css('display','inline');
                    element.toggleClass('down');
                }
            }

            if (jQuery(this).siblings('li').hasClass('down')){
                navToggle(jQuery(this).siblings('li'));
            }
            navToggle(jQuery(this));


        });
        jQuery('#menu-main-menu > li.menu-item > a').append('<i></i>');

    </script>
        <?php

            if(is_page_template( 'template-treatments.php' )){ ?>
                <script src="<?php echo get_template_directory_uri(); ?>/js/jquery.scrollTo-min.js" type="text/javascript"></script>
                <script src="<?php echo get_template_directory_uri(); ?>/js/autocolumn.min.js" type="text/javascript"></script>
                <script type="text/javascript">
                    jQuery(document).ready(function(){
                        jQuery('.page-nav a').click(function(e){
                            e.preventDefault();
                            var aTag = jQuery(this).attr('href');
                            jQuery.scrollTo( aTag, 500);
                        });

                    });
                    jQuery(function(){
                            jQuery('.copy-wrapper').columnize({
                                columns : 2
                            });
                            jQuery('.page-nav').columnize({
                                columns : 4
                            });
                        });
                </script>
